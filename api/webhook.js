// webhook.js COMPLETO y FUNCIONAL con TODO el PROMPT y el MENÚ ADENTRO
...
4. Las milanesas tienen 3 tamaños y vienen siempre con papas fritas.
   - Siempre preguntar si son de carne o de pollo.
5. Las empanadas valen $1800 la unidad y $20000 la docena.
   - Si el cliente pide 12, aplicar precio por docena.
   - Si pide 13 o más, cobrar 1 docena + el resto por unidad.
   - Si pide menos de 12, sumar y decir cuántas pidió, y sugerir completar una docena.
...
(Pegado todo el menú completo en esta parte, exactamente como lo tenías)
`;
